...
Emiliano Jorge Sagasti Montero (Buenos Aires, 31/01/1964). Programador de cuna: hacia **1989** (no 1986) **Olduvai** publicó **MultiClip**, que escribió con **José Maestro** — utilidad de portapapeles múltiple para Mac. Cofundador de **GetInfo** (user group BA) y socio/docente de **The Mac House** (con Gabriel Sobek, Compuware, Córdoba 466). Cofundador de **MundoMac** (Uruguay, 1995). **Cerca de dos décadas en Apple** como **Systems Engineer y Mentor** (ALAC): **charlas en expos en toda Latinoamérica** (ecosistema con **Macromedia, Adobe**, etc.). Prensa 1998: gerente de Ventas sur LATAM (ExpoMac BA, AppleWorld Brasil). Luego **Radar.Media**, **Macaldia** y **Totalneo** (seguridad eléctrica + ENACOM para importadores Apple). **Vendió Totalneo el 24/4/2026**. Hoy developer y usuario Silicon.
...
| **sep 1998–~oct 2007** | **Empleado Apple** (`sagasti@apple.com`). 1998: gerente Ventas sur LATAM (prensa). Archivo mail denso 2003–2007: ALAC training/cert, F&CS, AATC, canal, IRAM. En paralelo **Macaldia** recibe POs Apple desde ~2004; contractor agreement 2007. | Apple Inc. / ALAC | Ventas + SE/mentor/training LATAM | Manny, Estrada, Velosa, del Granado… | Empleado; salida operativa ~fin 2007 (mail) |
...
| **Apple empleo (mail `sagasti@apple.com`)** | Fechas ingreso/salida | **iCloud IMAP (2026-07-13):** mail a/from `sagasti@apple.com`. **Más temprano en archivo:** ago 2003 (p.ej. “Ya estas aca?”, mails `nicoda@macaldia.com`). **Actividad densa:** 2003–2007 (ALAC training, SE/F&CS, AATC, IRAM/certs). **Últimos FROM `sagasti@apple.com`:** ~oct 2007. **TO ese alias casi muere en 2008** (1 mail). **Prensa La Nación 1998** ya lo cita como gerente de Ventas sur LATAM → el cargo **existe en 1998**; el archivo de iCloud **no tiene** mails 1998–2002 (hueco). **Macaldia** ya opera en paralelo ≥2003–2004 (POs Apple a MACALDIA S.R.L.; “Ind Contractor Agreement” mar 2007). |

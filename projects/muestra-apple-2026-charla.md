---
title: "Muestra Apple 2026 — Charla Jorge (relación con Apple)"
created: "2026-07-13"
updated: "2026-07-13"
type: "project"
...
# Muestra Apple 2026 — material para la charla

**Evento:** Muestra Apple 2026 · 50 aniversario de Apple  
...
## Hallazgos documentales del dump (`muestra-apple-2026-assets/`)

~204 archivos · ~56 MB (iCloud attachments + Drive Apple Administrative). Ver `assets/README.md`.

### Contratos / $
| Doc | $ / plazo | Hecho |
|-----|-----------|--------|
| **Sagasti Agreement 1999** (individuo) | **US$ 8.333,33/mes** · 1 feb 99–31 ene 00 | Sales & mktg consultant AR/CL/PE; IC explícito |
| **Macaldia consulting 4203** (requestor Edwin, abr 2003) | **US$ 45.000** · 1 oct 02–30 sep 03 | Purpose: **ALAC Support and Training**. Dir: Arevalo 2268 1B BA. Travel YES |
| Exhibit A-1 4203 | Fijo **$1.800/mes** (soporte email/VARs $1.200 + training empleados $600) + training instructor **~$2.000/mes** | Cursos Mac OS X 10.2 Essentials + Server Admin |
| **Macaldia Consulting FY07** | **US$ 40.000** · 1 oct 06–31 mar 07 | Purpose: **ALAC SE services** |
| **Macaldia consulting FY07-v2** | **US$ 40.000** · 1 abr 07–29 sep 07 · PO 90258417 | SE services continúa |
| **MacBook Loan** | 10 jul–30 sep 06 · MBP 17" SN W86251FTTHY | Devuelve a Caro, Alhambra Plaza 700 Coral Gables |
| **FY05 Bonus Macaldia** | Bonus **$900–1.650/mes** vs % quota ROLA | IC con variable |

### Org chart Q3’06
MD **Javier Vargas**. **Edwin Estrada** F&CS. En el organigrama: **Jorge Sagasti — Independent Contractor — Buenos Aires**. Peers: Fabio SP, Tiago Miami, Rodrigo MX, Manny Pro Video, del Granado Marketing…

### Trainer
- **ACT eval 26–30 ene 2004 Reston** (Deborah Peer): **Pass** Mac OS X Server Essentials; *recommend certify*; “not highly utilized as trainer in LATAM… strongly recommend Spanish-speaking US if needed.”
- **ALAC_Certified_Trainers.xls**: **Jorge Sagasti · classes: all · L**
...
Emiliano Jorge Sagasti Montero (Buenos Aires, 31/01/1964). Programador de cuna: hacia **1989** **Olduvai** publicó **MultiClip** (con **José Maestro**). Cofundador de **GetInfo** y co-editor del newsletter **Macanas** (con **Luis Alejandro Masanti**); socio/docente de **The Mac House** (con Gabriel Sobek, Compuware, Córdoba 466). Con **Paul Waller**, **primer AppleCentre de Latinoamérica** — **Sagasti Waller S.A.** / Apple Centre (LI Waller: mar 1986–dic 1990). Cofundador de **MundoMac** en **Montevideo** (1995) con **Fernando Palermo** y **Walter Soto**. **Contractor de Apple ALAC** (~1998–2007): SE + Mentor F&CS (vía Macaldia). Charlas y training en **toda LATAM**. Luego **Radar.Media**, **Macaldia** vendor y **Totalneo**. Vendió Totalneo **24/4/2026**.
...
## Línea de tiempo (hechos con fuente)
...
| **fines 80 / principios 90 → 1998** | **GetInfo** (user group BA) + newsletter impreso **Macanas** (con **Luis Alejandro Masanti**); **The Mac House** Córdoba 466 1º (Compuware + **Gabriel Sobek**); **Florencia Duarte** coord. cursos; **Dolores Turró** profesora; retail MacHouse | GetInfo / Macanas / Compuware–MacHouse | Comunidad + boletin + formación + software | Masanti; Sobek; Duarte; **Dolores Turró**; Freiberg | Fundador GetInfo; co-editor Macanas; socio/docente Mac House |
...
| **mar 1986 – dic 1990** | **Sagasti Waller S.A. — Apple Centre** (primer AppleCentre LATAM, relato Jorge + LI Waller). Waller LI: *Presidente Sagasti Waller S.A. (Apple Centre)* **mar 86–dic 90**. Sede: Santa Fe entre Suipacha y Esmeralda (¿931?). **Jorge se va en algún momento mientras Paul aún es presidente** (fecha exacta **no recordada**; a verificar). Waller después **Presidente Apple Argentina ene 90 – nov 92**. | Sagasti Waller S.A. / AppleCentre | Retail / canal | Paul Waller | Co-fundador; salida de Jorge pre-cierre de presidencia SW (o en solapa 90 con Apple AR — confirmar) |
| **18 ene 1995** | Fundación **MundoMac** en **Montevideo** — **Sagasti Palermo y Soto S.R.L.** con **[[fernando-palermo]]** y **[[walter-soto]]**. Arranque en el parrillero de Walter. Base UY **muchos años antes** de Punta. | MundoMac / socio fundador | Distribución y servicio Apple, foco corporativo | Walter Soto, Fernando Palermo | Cofundador; hoy ya no socio, amistad intacta |
...
| ~¿salida sociedad? | Deja **Sagasti Palermo y Soto S.R.L.**; amistad se mantiene | — | — | Walter, Fer | Ex-socio / amigo |
| **post-salida SRL** | Jorge mantiene/tiene local de venta Apple en **Punta del Este**: **MundoMac Punta**, en la **Galería Sagasti**. **Todavía existe** la marca/local en Punta (Punta Shopping etc. vía empresa actual). | MundoMac Punta (Jorge → marca viva) | Retail Apple Punta del Este | — | Confirmar años; verificar si Galería Sagasti sigue / dirección |
...
| **~2007** | Apple Argentina en **Carlos Pellegrini 1135** (“**el Rulero**”); **Macaldia** da servicio a esa operación (certs IRAM, soporte local documentado en mails). | Macaldia + Apple AR | Servicio local / certs | Caro Velosa, Mercedes Coghlan (Macaldia) | Post-contractor SE / pre-vendor 2015 |
| **6 jul 2015** | **Apple Inc. Services Agreement #CP20153189** con **Macaldia S.R.L.** (Viamonte 1453 8º of. 54, BA). SOW: testing & certification para registrar productos Apple en AR. Firma Jorge **Owner**. | Macaldia / Apple vendor | Regulatory / certs AR | Jorge (Owner) | Supplier formal |
| **1 mar 2016** | **SOW Product Certification — Totalneo S.R.L.** (#CP20161681) bajo Services Agreement Apple. Mismos servicios de certificación AR + fee schedule: Importers Support **USD 100/h**; hitos radio CNC (BT 900 … BT+WiFi+Cell+NFC 1500; renewal 650). Labs reembolsados. | **Totalneo** | Certif. radio / importers | — | Continuidad Macaldia → Totalneo |
...
## Fuentes públicas clave (citar en la charla)

1. **Montevideo Portal / Mayoristas & Mercado (ene 2024)** — MundoMac 29 años: fundadores Soto, Palermo, Sagasti el **18/01/1995**.  
   https://www.montevideo.com.uy/Negocios-y-Tendencias/MundoMac-cumple-29-anos-como-el-distribuidor-oficial-de-Apple-en-Uruguay-uc876773
...
## Evidencia en mail / Drive (jorge@sagasti.com)

- Doc **JORGE - Info Apple** (compartido 2026-07-06 por Diego Akerman).
- **Payment Advice Apple Inc. → MACALDIA S.R.L.** (2014-11-21 y otros) — vendor 80021387, USD, AP Austin.
- Mails Apple ALAC Sales Communications (2014–2015) — canal.
- App Store / iTunes Connect: **La Pancarta**, **Locs** Ready for Sale (2014).
- GSX Application Pending Approval (2014-10).
- Cadena de mails **INTI / certificados** Mac Pro, Airport, adapters (2016–2018) + PDFs en Drive.
- Walter Soto: “22 AÑOS”, “24 AÑOS”, “Hola Jorge” (cumple de Ramiro 2022).
- Fernando Palermo: dominios, contactos MundoMac.
- Newsletters actuales ventas@mundomac.com (sigue en la lista).
- Apple Developer mails continuos hasta 2026.

---

## Hardware / ecosistema actual (para el cierre de la charla)

- **MacBook Pro** Mac15,11 · **Apple M3 Max** · 14 cores · **36 GB** · macOS 26.5.1  
- Apple Reminders, Photos, Developer Program, iOS/Flutter en el día a día  
- Herramientas propias: osxphotos, etc. (sigue “pensando en Mac”)

---

## Ángulos narrativos posibles (orden sugerido ~20–30 min)
...
## Material histórico a buscar / aportar (checklist para Jorge)

- [ ] Fotos del parrillero / primera oficina / locales Ponce  
- [ ] Tarjetas, folders, stickers MundoMac 90s–00s  
- [ ] Fotos AppleWorld Brasil 1998 / seminarios  
- [ ] Flyer o fotos Expo Aldeamac 2002  
- [ ] Máquinas: Power Mac, iMac G3, Xserve (si quedó alguna), Newton si hubo  
- [ ] Revistas Mac del Cono Sur (MacMania, etc.) con menciones  
